...
{
	titleText[format["%1 wurde als Beweismittel sicher gestellt, du hast eine Belohnung in höhe von $%2 erhalten.",_itemName,[(life_illegal_items select _illegal) select 1] call life_fnc_numberText],"PLAIN"];
...
if(_diff <= 0) exitWith {hint "Du kannst diesen Gegenstand nicht aufheben weil du voll bist."};
