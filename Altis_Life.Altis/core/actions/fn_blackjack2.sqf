...
if(life_cash < _price) exitWith {hint "Du hast nicht genug Geld dabei, eine Runde kostet $5000";};
life_cash = life_cash - _price;
removeAllActions blackjack2;
				...
				if (_number == 0) then {robberyreward = 7500; hint "19! Sauber, immerhin gewonnen!";};
				...
				if (_number == 7) then {robberyreward = 10000; hint "20! Fast perfekt! Du hast gewonnen!";};
...
sleep 10;
blackjack2 addAction["Black Jack spielen ($5000)",life_fnc_blackjack2,"blackjack2"];
life_action_inUse = false;