...
if(life_cash < _price) exitWith {hint "Du hast nicht genug Geld dabei, eine Runde kostet $10000";};
life_cash = life_cash - _price;
removeAllActions blackjack3;
				...
				if (_number == 7) then {robberyreward = 20000; hint "20! Fast perfekt! Du hast gewonnen!";};
				...
				if (_number == 10) then {robberyreward = 30000; hint "21!!! Jackpot!!";};
...
sleep 10;
blackjack3 addAction["Black Jack spielen ($10000)",life_fnc_blackjack3,"blackjack3"];
life_action_inUse = false;