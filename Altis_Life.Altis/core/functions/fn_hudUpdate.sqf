...
_money2 = _ui displayCtrl 23530;

_cash = life_cash;
_atmcash = life_atmcash;
...
//Update Money
_money ctrlSetPosition [safeZoneX+safeZoneW-0.112,safeZoneY+safeZoneH-0.410];
_money ctrlSetText format["%1", format["%1",[_cash] call life_fnc_numberText]];
_money ctrlCommit 0;
//Update Money
_money2 ctrlSetPosition [safeZoneX+safeZoneW-0.112,safeZoneY+safeZoneH-0.360];
_money2 ctrlSetText format["%1", format["%1",[_atmcash] call life_fnc_numberText]];
_money2 ctrlCommit 0;