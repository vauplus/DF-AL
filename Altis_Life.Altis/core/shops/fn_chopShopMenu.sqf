...
*/
if(life_action_inUse) exitWith {hint "Es wird bereits eine Aktion ausgeführt..."};
...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["Es befinden sich keine Fahrzeuge in der nähe zum verkaufen.","PLAIN"];};
if(!(createDialog "Chop_Shop")) exitWith {hint "Ups da gab es ein problem beim öffnen des Schwarzmarktes."};
