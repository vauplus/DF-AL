...
"Mietpreis: <t color='#8cff9b'>$%1</t><br/>Eigentumspreis: <t color='#8cff9b'>$%2</t><br/>Höchstgeschwindigkeit: %3 km/h<br/>PS: %4<br/>Passagiersitze: %5<br/>Kofferraumgröße: %6<br/>Tankvolumen: %7<br/>Panzerung: %8",
