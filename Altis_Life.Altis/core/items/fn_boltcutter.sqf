...
if(!(_building isKindOf "House_F")) exitWith {hint "Du schaust nicht auf die Haustür."};
...
if((nearestObject [[16019.5,16952.9,0],"Land_Dome_Big_F"]) == _building OR (nearestObject [[16019.5,16952.9,0],"Land_Research_house_V1_F"]) == _building) then {
	[[[1,2],"!!!!! IN DER ZENTRALBANK WIRD EINGEBROCHEN !!!!!!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
};
...
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 0) exitWith {hint "Die Tür ist bereits aufgebrochen!"};
life_action_inUse = true;

//Setup the progress bar
disableSerialization;
_title = "Breche Tür auf";
