...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","banana_1","banana_2","banana_3","tabak_1","holz_1","hopfen_1","frog_1","uran_1","coal"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["banana_1","banana_2","banana_3"]): {"banane"};
	case (_zone in ["tabak_1"]): {"tabaku"};
	case (_zone in ["holz_1"]): {"wood"};
	case (_zone in ["hopfen_1"]): {"hopfer"};
	case (_zone in ["frog_1"]): {"frogu"};
	case (_zone in ["uran_1"]): {"uranore"};
	case (_zone in ["coal"]): {"coal"};
	default {""};
};
