...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\medic_offroad.paa","med"],
			["textures\dhl_off.paa","civ"],
			["textures\monster_off.paa","civ"],
			["textures\rockstar_off.paa","civ"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\civil_suv.paa","civ"],
			["textures\ferrari_suv.paa","civ"],
			["textures\monster_suv.paa","civ"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["textures\medic_hummingbird.paa","med"]
		];
	};
