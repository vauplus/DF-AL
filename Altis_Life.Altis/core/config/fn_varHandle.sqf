...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "banane": {"life_inv_banane"}; //edit
			case "tabaku": {"life_inv_tabaku"}; //edit
			case "tabakp": {"life_inv_tabakp"}; //edit
			case "bohrer": {"life_inv_bohrer"}; //edit
			case "wood": {"life_inv_wood"}; //edit
			case "coal": {"life_inv_coal"};
			case "uranore": {"life_inv_uranore"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_banane": {"banane"}; //edit
			case "life_inv_tabaku": {"tabaku"}; //edit
			case "life_inv_tabakp": {"tabakp"}; //edit
			case "life_inv_bohrer": {"bohrer"}; //edit
			case "life_inv_wood": {"wood"}; //edit
			case "life_inv_coal": {"coal"};
			case "life_inv_steel": {"steel"};
			case "life_inv_uranore": {"uranore"};
