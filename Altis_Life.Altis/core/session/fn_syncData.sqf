...
if(life_session_time) exitWith {hint "Du hast bereits gespeichert, du kannst nur alle 5 Minuten speichern!";};
...
hint "Spiel wird gespeicher.\n\nBitte warte 20 sekunden bevor du das Spiel verlässt.";
[] spawn
{
