/*
	...
	option is presented.
*/
private["_appleZones","_peachZones","_heroinZones","_cocaineZones","_weedZones","_bananeZones","_tabakZones","_woodZones","_hopfenZones","_frogZones"];
...
_weedZones = ["weed_1"];
_bananeZones = ["banana_1","banana_2","banana_3"];
_tabakZones = ["tabak_1"];
_woodZones = ["holz_1"];
...
//Create bananen zones
{
	_zone = createTrigger ["EmptyDetector",(getMarkerPos _x)];
	_zone setTriggerArea[50,50,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Banane = player addAction['Bananen pflücken',life_fnc_gatherBanane,'',0,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Banane;"];
...
//Create tabak zones
{
	...
	_zone setTriggerArea[100,100,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Tabak = player addAction['Tabak pflücken',life_fnc_gatherTabak,'',0,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Tabak;"];
} foreach _tabakZones;
...
//Create wood zones
{
	...
	_zone setTriggerArea[100,100,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Wood = player addAction['Holz sammeln',life_fnc_gatherWood,'',0,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Wood;"];
} foreach _woodZones;
...
//Create hopfen zones
{
	...
	_zone setTriggerArea[100,100,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Hopfen = player addAction['Hopfen sammeln',life_fnc_gatherHopfen,'',0,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Hopfen;"];
...
//Create frog zones
{
	...
	_zone setTriggerArea[100,100,0,false];
	_zone setTriggerActivation["CIV","PRESENT",true];
	_zone setTriggerStatements["player in thislist","LIFE_Action_Frog = player addAction['Frösche sammeln',life_fnc_gatherFrog,'',0,false,false,'','!life_action_inUse'];","player removeAction LIFE_Action_Frog;"];
} foreach _frogZones;