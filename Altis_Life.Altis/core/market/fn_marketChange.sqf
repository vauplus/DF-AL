...
_rand = [0,100] call life_fnc_randomRound; //0-200
...
switch(true) do
{
	...
	{
		[[0,"News: Die Wissenschaftler von Altis haben herausgefunden das Zigaretten Gesundheitsschäden verursacht!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
		
		["tabaku", [15,30] call life_fnc_randomRound, true] call life_fnc_marketSell; 
		["tabakp", [15,30] call life_fnc_randomRound, true] call life_fnc_marketSell; 
		
		diag_log "+Market+ Event tabakm";
	};
	...
	{
		[[0,"News: Die Nachfrage nach Zigaretten in Altis steigt täglich an!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
		
		["cement", [15,30] call life_fnc_randomRound, true] call life_fnc_marketBuy; 
		["oilp", [15,30] call life_fnc_randomRound, true] call life_fnc_marketBuy; 
		["iron_r", [15,30] call life_fnc_randomRound, true] call life_fnc_marketBuy; 
		["glass", [15,30] call life_fnc_randomRound, true] call life_fnc_marketBuy;
