...
if(_value > 0) then
{
	[[0,format["Ein Fahrzeug wurde durchsucht und es wurde Illegale Ware im Wert von $%1 sichergestellt.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "In diesem Fahrzeug befindet sich keine Illegale Ware.";
};