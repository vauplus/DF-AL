...
_control ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>%1 hat dir einen Strafzettel in Höhe von $%2 ausgestellt",_cop getVariable["realname",name _cop],_val];
[] spawn
{
	disableSerialization;
	...
	{
		[[0,format["%1 hat es abgelehnt das Ticket zu bezahlen.",player getVariable["realname",name player]]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
		[[1,format["%1 hat es abgelehnt das Ticket zu bezahlen.",player getVariable["realname",name player]]],"life_fnc_broadcast",life_ticket_cop,false] spawn life_fnc_MP;
	};
};