...
if(count _sellers == 0) exitWith {hint "Keiner hat hier etwas verkauft."}; //No data.
...
hint parseText format["Die folgenden Spieler haben vor kurzem hier verkauft.<br/><br/>%1",_names];
